...
Static bench calculators for RF lab work. Hosted as GitHub Pages so they are a tap away next to a PNA.
...
Converts PNA source power to output voltage peak-to-peak (VOPP) and back.
...
- dBm is **available power per port** — the PNA source-power setting.
